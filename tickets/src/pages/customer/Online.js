...
const Online = ({ ...props }) => {
    ...
    useEffect(() => {
        const fetchCustomers = async () => {
            setLoading(true);
            const response = await http.get(`${process.env.REACT_APP_API_URL}/list-online-customers?q=${searchText}&page=${page}&per_page=${perPage}&sort_col=${sortCol}&sort=${sort}&status=${status}`);
