...
const TicketsList = ({ user }) => {
  ...
  useEffect(() => {
    ...
    if (!typeParam && !statusParam && !filterParam) return;
  ...
  const POPOVER_CONTENT_MAX_HEIGHT = 220;
      ...
      <Content>
        ...
        {priorityPopover.open && (
          <div
            ...
            style={{
              position: 'fixed',
              top: priorityPopover.top,
              left: priorityPopover.left,
              display: 'block',
              width: POPOVER_WIDTH
            }}
          >
            ...
            <div className="webui-popover-inner">
              ...
              <div className="webui-popover-content">
                <div className="popover-scroll" style={{ maxHeight: POPOVER_CONTENT_MAX_HEIGHT }}>
                  <ul className="popover-dropdown">
                    {[
                      ...
                      <li key={opt.key} className={priorityPopover.selected === opt.key ? 'selected' : ''} onClick={() => selectPriority(opt.key)}>
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                          <span>
                            <label className={`badge ${opt.badge}`}>{opt.label}</label>
                          </span>
                ...
                <div className="popover-scroll" style={{ maxHeight: POPOVER_CONTENT_MAX_HEIGHT }}>
                  <ul className="popover-dropdown">
                    {[
                      ...
                      <li key={opt.key} className={statusPopover.selected === opt.key ? 'selected' : ''} onClick={() => selectStatus(opt.key)}>
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                          <span>
                            <label className={`badge ${opt.badge}`}>{opt.label}</label>
                          </span>
            ...
            <div className="webui-popover-inner">
              ...
              <div className="webui-popover-content">
                <div className="popover-scroll" style={{ maxHeight: POPOVER_CONTENT_MAX_HEIGHT }}>
                  <ul className="popover-dropdown">
                    {typeOptions.map((opt) => (
                      <li key={opt} className={typePopover.selected === opt ? 'selected' : ''} onClick={() => selectType(opt)}>
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
        ...
        {groupPopover.open && (
          <div
            ...
            style={{
              position: 'fixed',
              top: groupPopover.top,
              left: groupPopover.left,
              display: 'block',
              width: POPOVER_WIDTH
            }}
          >
                ...
                <div className="popover-scroll" style={{ maxHeight: POPOVER_CONTENT_MAX_HEIGHT }}>
                  <ul className="popover-dropdown">
                    {['IT', 'Finance', 'Sales', 'Any'].map((opt) => (
                      <li key={opt} className={groupPopover.selected === opt ? 'selected' : ''} onClick={() => selectGroup(opt)}>
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                          <span>{opt}</span>
        ...
        {assignedToPopover.open && (
          <div
            ...
            style={{
              position: 'fixed',
              top: assignedToPopover.top,
              left: assignedToPopover.left,
              display: 'block',
              width: POPOVER_WIDTH
            }}
          >
