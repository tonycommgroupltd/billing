...
const List = ({ ...props }) => {
    ...
    useEffect(() => {
        const fetchPayments = async () => {
            setLoading(true);
            const response = await httpNode.get(`/finance/mpesa?q=${searchText}&page=${page}&per_page=${perPage}&sort_col=${sortCol}&sort=${sort}&start=${startDate}&end=${endDate}`);
