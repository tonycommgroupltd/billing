              ...
              <BlockDes className="text-soft">
                <p>
                  {isTechnician
                    ...
                    : isAllItemsList
                      ? "Tap a card below to filter by type"
                      : `Showing ${activePreset.label.toLowerCase()}`}
                </p>
              </BlockDes>
            </BlockHeadContent>
            {isAdmin && (
