...
const Homepage = () => {
  ...
  useEffect(() => {
    ...
    const fetchDashboardStats = async () => {
      //setApiLoading(true);
      try {
        const response = await http.get(`${process.env.REACT_APP_API_URL}/dashboard-stats`);
    ...
    fetchDashboardStats();
    const timer = setInterval(fetchDashboardStats, 10000);
    socket.on('notification', function (data) {
      if (data.params[1] == 'usage:::') {
        setCpuUsage(data.params[2]);
        setIowait(data.params[3]);
      }
    });
      ...
      <Content>
        ...
        <Block>
          <Row className="g-gs dashboard-top">
            <Col md="4" className="dashboards-top-block-item">
              <Card>
                <div className="card-inner p-0">
                  ...
                  <div className="dashboards-top-block-item-bottom">
                    ...
                    <span id="dashboard_top_online" className="count">{data?.online_customers ?? 0}</span>
                  </div>
            ...
            <Col md="4" className="dashboards-top-block-item">
              <Card>
                <div className="card-inner dashboards-top-block-item p-0">
                  ...
                  <div className="dashboards-top-block-item-bottom">
                    <span className="view">View</span>
                    <span id="dashboard_top_online" className="count">{data?.new_customers ?? 0}</span>
                  </div>
              ...
              <Card>
                <div className="card-inner dashboards-top-block-item p-0">
                  <div className="dashboards-top-block-item-title">
                    ...
                    <span className="text">New & open tickets</span>*/}
                    <span className="icon-wrap">
                  ...
                  <div className="dashboards-top-block-item-bottom">
                    <span className="view">View</span>
                    <span id="dashboard_top_online" className="count">{data?.this_month_unpaid_invoices ?? 0}</span>
                  </div>
          ...
          <div className="shortcuts-wrap dashboard-shortcut mt-0 mb-24">
            ...
            <div className="shortcuts-list">
              <div className="shortcuts-button">
                <Link to="/admin/customers/add" className="button-purple" title="Add customer">
                  <span className="icon-wrap me-4">
                    <Icon name="user-add" />
                  </span>
                  <span className="button-title"><span>Add customer</span></span>
                </Link>
              </div>
              <div className="shortcuts-button">
                <Link to="/admin/networking/routers/add" className="button-success" title="Add router">
                  <span className="icon-wrap me-4">
                    <Icon name="network" />
                  </span>
                  <span className="button-title"><span>Add router</span>
                  </span>
                </Link>
              </div>
            </div>
          ...
          <Row className="g-gs">
            <Col sm="6">
                      ...
                      <li className="list-group-item"> CPU usage
                        <div className="progressBarHolder">
                          <div id="dashboard_status_cpu_usage_progress" className="progress progress-free">
                            <div role="progressbar" className="progress-bar bg-warning" style={{ width: cpuUsage + '%' }}>
                              <span id="dashboard_status_cpu_usage" className="progress-value">{cpuUsage} %</span>
                            </div>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="list-group-item"> I/O wait
                        <div className="progressBarHolder">
                          <div id="dashboard_status_iowait_progress" className="progress progress-free">
                            <div role="progressbar" className="progress-bar bg-warning" style={{ width: iowait + '%' }}>
                              <span id="dashboard_status_iowait" className="progress-value">{iowait} %</span>
                            </div>
                          </div>
                        </div>
                      </li>
                  ...
                  <div className="card-body">
                    <ul className="list-group list-group-striped">
                      <li className="list-group-item"> Routers
                        <span id="admin_dashboard_panels_networking_routers" className="list-group-item-value">{data?.all_routers ?? 0}</span>
                      </li>
                      <li className="list-group-item"> Monitoring devices
                        <span id="admin_dashboard_panels_networking_monitoring" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Devices down (SNMP)
                        <span id="admin_dashboard_panels_networking_monitoring_snmp" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Devices down (Ping)
                        <span id="admin_dashboard_panels_networking_monitoring_ping" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> IPv4 networks
                        <span id="admin_dashboard_panels_networking_networks" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Total private addresses
                        <span id="admin_dashboard_panels_networking_private_total" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Private addresses used
                        <span id="admin_dashboard_panels_networking_private_used" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Total public addresses
                        <span id="admin_dashboard_panels_networking_public_total" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Public addresses used
                        <span id="admin_dashboard_panels_networking_public_used" className="list-group-item-value">0</span>
                      </li>
                    </ul>
                  </div>
                </Collapse>
              ...
              {/* <Card className="dashboard-status spl-collapsed-panel">
                <div className="card-header dropup" onClick={toggleLead}>
                  ...
                  <div className="pull-right">
                    <span className="close-card-btn icon-wrap">
                      {isLeadOpen ? <Icon name="downward-ios" /> : <Icon name="upword-ios" />}
                    </span>
                  </div>
                </div>
                <Collapse isOpen={isLeadOpen}>
                  <div className="card-body">
                    <ul className="list-group list-group-striped">
                      <li className="list-group-item"> Tasks for today
                        <span id="admin_dashboard_panels_crm_today_tasks" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> New leads
                        <span id="admin_dashboard_panels_crm_new_leads" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Active leads
                        <span id="admin_dashboard_panels_crm_active_leads" className="list-group-item-value">0</span>
                      </li>
                      <li className="list-group-item"> Deals
                        <span id="admin_dashboard_panels_crm_deals" className="list-group-item-value">0</span>
                      </li>
                    </ul>
                  </div>
                </Collapse>
            ...
            <Col sm="6">
                  ...
                  <div className="card-body">
                    <ul className="list-group list-group-striped">
                      ...
                      <li className="list-group-item"> Payments <span id="admin_dashboard_panels_finance_current_payments"
                        className="list-group-item-value">{data?.this_month_payments ?? 0} ({data?.sum_this_month_payments ?? '0.00'}&nbsp;Sh)</span></li>
                      <li className="list-group-item"> Paid invoices <span id="admin_dashboard_panels_finance_current_paid_invoices"
                        className="list-group-item-value">{data?.this_month_paid_invoices ?? 0} ({data?.this_month_paid_invoices_sum ?? 0.00}&nbsp;Sh)</span></li>
                      <li className="list-group-item"> Unpaid invoices <span
                        id="admin_dashboard_panels_finance_current_unpaid_invoices" className="list-group-item-value">{data?.this_month_unpaid_invoices ?? 0} ({data?.this_month_unpaid_invoices_sum ?? 0.00}&nbsp;Sh)</span></li>
                    ...
                    <ul className="list-group list-group-striped">
                      ...
                      <li className="list-group-item"> Payments <span id="admin_dashboard_panels_finance_last_payments"
                        className="list-group-item-value">{data?.last_month_payments ?? 0} ({data?.sum_last_month_payments ?? '0.00'}&nbsp;Sh)</span></li>
                      <li className="list-group-item"> Paid invoices <span id="admin_dashboard_panels_finance_last_paid_invoices"
                        className="list-group-item-value">{data?.last_month_paid_invoices ?? 0} ({data?.last_month_paid_invoices_sum ?? 0.00}&nbsp;Sh)</span></li>
                      <li className="list-group-item"> Unpaid invoices <span id="admin_dashboard_panels_finance_last_unpaid_invoices"
                        className="list-group-item-value">{data?.last_month_unpaid_invoices ?? 0} ({data?.last_month_unpaid_invoices_sum ?? 0.00}&nbsp;Sh)</span></li>
              ...
              {/*<Card className="dashboard-status spl-collapsed-panel">
                ...
                <Collapse isOpen={isTickOpen}>
                  <div className="card-body">
                    <ul className="list-group list-group-striped">
                      <li className="list-group-item"> New <span id="admin_dashboard_panels_tickets_1"
                        className="list-group-item-value">0</span></li>
                      <li className="list-group-item"> Work in progress <span id="admin_dashboard_panels_tickets_2"
                        className="list-group-item-value">0</span></li>
                      <li className="list-group-item"> Resolved <span id="admin_dashboard_panels_tickets_3"
                        className="list-group-item-value">0</span></li>
                      <li className="list-group-item"> Waiting on agent <span id="admin_dashboard_panels_tickets_5"
                        className="list-group-item-value">0</span></li>
                    </ul>
                  </div>
                </Collapse>
