...
const List = ({ ...props }) => {
    ...
    const columns = [
        {
            ...
            name: "ID",
            cell: (row) => (
                <Link to={`${process.env.PUBLIC_URL}/admin/tariffs/internet--edit/${row.id}`}>{row.id}</Link>
            ),
            selector: (row) => row.id,
            width: "80px",
            wrap: true,
        ...
        },
        {
            ...
            name: "Title",
            cell: (row) => (
                <Link to={`${process.env.PUBLIC_URL}/admin/tariffs/internet--edit/${row.id}`}>{row.title}</Link>
            ),
        ...
        },
        {
            id: 3,
            name: "Weekly",
            selector: (row) => Number(row.weekly_price).toFixed(2) + ' Sh',
            wrap: true,
            sortable: true,
            ref: "weekly_price"
        },
        {
            id: 4,
            name: "Bi-Weekly",
            selector: (row) => Number(row.bi_weekly_price).toFixed(2) + ' Sh',
            wrap: true,
            sortable: true,
            ref: "bi_weekly_price"
        },
        ...
        },
        {
            id: 6,
            name: "Rate Limit",
            selector: (row) => row.rate_limit.label,
            wrap: true,
            sortable: false,
            ref: "rate_limit",
        },
        {
            ...
            cell: (row) => (
                <ul className="nk-tb-actions gx-1">
                    <li>
                        <Link to={`${process.env.PUBLIC_URL}/admin/tariffs/internet--edit/${row.id}`}>
    ...
    useEffect(() => {
        const fetchCustomers = async () => {
            setLoading(true);
            const response = await http.get(`${process.env.REACT_APP_API_URL}/list-plans?q=${searchText}&page=${page}&per_page=${perPage}&sort_col=${sortCol}&sort=${sort}&status=${status}`);
                            ...
                            <div className="nk-block-tools-toggle">
                                ...
                                <div className="toggle-expand-content" style={{ display: sm ? "block" : "none" }}>
                                    <ul className="nk-block-tools g-3">
                                        <li>
                                            <Link to="/admin/tariffs/internet--add" className="btn btn-primary">
