...
export const authorizationOptions = [
  { value: "", label: "None" },
  { value: 1, label: "Firewall IP-MAC filter" },
  { value: 2, label: "DHCP (Leases)" },
  { value: 3, label: "PPP/DHCP (Radius)" },
  { value: 4, label: "PPP (Secrets)" },
  { value: 5, label: "Hotspot (Users)" },
  { value: 6, label: "Hotspot (Radius)" },
];
