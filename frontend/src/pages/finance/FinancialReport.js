...
const FinancialReport = () => {
  ...
  const buildCustomerPieChart = () => {
    ...
    return {
      labels: labels.map((l) => (l === "Active" ? "Active / Online Services" : "Expired / Disabled Services")),
      datasets: [
        {
          data: values,
              ...
              <Row className="g-gs">
                ...
                <Col xl="4" lg="5">
                  <Card className="card-bordered card-full">
                    <div className="card-inner">
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <h6 className="title mb-0">Service Overview</h6>
                      ...
                      <div style={{ height: 260 }} className="d-flex align-items-center justify-content-center">
                        {buildCustomerPieChart() ? (
                          ...
                          <div className="text-center text-soft">No service data</div>
                        )}
                      </div>
                          ...
                          {Object.entries(trends.statusBreakdown).map(([label, count]) => {
                            ...
                            return (
                              <div key={label} className="d-flex justify-content-between mb-1" style={{ fontSize: 12 }}>
                                <span>{label === "Active" ? "Active / Online Services" : "Expired / Disabled Services"}</span>
            ...
            <Block className="mt-4">
              <Row className="g-gs">
                ...
                <Col lg="3">
                  <Card className="card-bordered card-full">
                    <div className="card-inner">
                      <h6 className="title mb-3">Customers & Services</h6>
                      <div className="d-flex flex-column gap-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          <span className="text-soft" style={{ fontSize: 12 }}>Total Services</span>
                          <span style={{ fontSize: 18, fontWeight: 700, color: COLORS.dark }}>{fmtNum(data.services?.total || 0)}</span>
                        </div>
                        {Object.entries(data.services?.statuses || {}).map(([label, info]) => {
                          const total = data.services?.total || 1;
