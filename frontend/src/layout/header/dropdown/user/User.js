      ...
      <DropdownMenu end className="dropdown-menu-md dropdown-menu-s1">
        ...
        <div className="dropdown-inner">
          <LinkList>
            ...
            {typeof window !== "undefined" && window.tonycommDesktop?.isDesktop ? (
              <li>
                <a
                  href="#check-updates"
                  onClick={(ev) => {
                    ev.preventDefault();
                    toggle();
                    if (typeof window.tonycommDesktop.checkForUpdates === "function") {
                      window.tonycommDesktop.checkForUpdates();
                    }
                  }}
                >
