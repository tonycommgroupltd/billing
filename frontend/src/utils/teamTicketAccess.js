...
const ELEVATED_ROLES = ['administrator', 'super-administrator', 'ict', 'super-admin', 'manager'];
...
export async function fetchTeamGroupTickets(http, { excludeResolved = true } = {}) {
  ...
  return {
    tickets,
    memberIds,
    // True when API had no usable assignee tokens — caller should fall back to full list.
